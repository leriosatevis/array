 ...
 *
 * @param <E> the type of elements held in this collection. It represents the data type of the elements that the list will store.
 */
public class SortedIntList<E> implements Iterable<SortedIntList.Node<E>> {
    int size = 0; // size of the list
    Node<E> first; // reference to the first node in the list
    private NodePool<E> nodePool = new NodePool<E>(); // avoid allocating nodes using NodePool
    private transient Iterator iterator; // iterator for traversing the list
